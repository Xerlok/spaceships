...
const boardOne = new Gameboard(player1, gameState);
boardOne.buildBoard();
...
addEventListeners(boardOne, gameState);
boardOne.player.active = true;
gameState.currentPlayer = boardOne.player.type;

const boardTwo = new Gameboard(player2, gameState);
boardTwo.buildBoard();
...
addEventListeners(boardTwo, gameState);
